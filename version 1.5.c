...
void updateGameData(game* GAMEDATA)
{
	...
	GAMEDATA->blueDotPulseTimer += GAMEDATA->delta;
...
int main(int argc, char** argv)
{
	...
	while (!GAMEDATA.quit)
	{
		...
		handleBlueDot(&BLUE, &SNAKE, &GAME, &GAMEDATA); //switched kolejnosc with handle snake
