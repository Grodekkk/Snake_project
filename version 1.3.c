...
#define SNAKE_INITIAL_SPEED 0.1
...
#define MINIMUM_SPEED 0.1					//minimal snake speed [seconds]
...
typedef struct {
	...
	int newCellNumber;												//used in lenghtening, number of snake new body part
...
void drawReqScreen(sdl* GAME, colors* COLOR, game* GAMEDATA)
{
	...
	sprintf(GAMEDATA->text, "A, B, WIP: C");
